...
navigateMensFashionMore(service){
  this.props.navigation.navigate("VehiclesMore",{screen: "VehiclesMore",Service:service,onGoBack: () => this.autoRefresh(),})
}
    ...
    return (
      ...
      <View style={styles.containerr}>
        ...
        <TouchableOpacity style={styles.drawerIcon} onPress={this.handleBackButtonClick}>
            ...
            <Text style={styles.headerTextMain}>Vehicles
            </Text>
        </LinearGradient>
