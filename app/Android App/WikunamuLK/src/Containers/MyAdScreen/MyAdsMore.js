...
export default class MyAdsMore extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      item_condition:this.props.navigation.state.params.Service.ad_item_condition,
    ...
    return (
      ...
      <StatusBar backgroundColor="#3764ad" barStyle="light-content"/>
        ...
        <TouchableOpacity style={styles.drawerIcon} onPress={this.handleBackButtonClick}>
            ...
            <Text style={styles.headerTextMain}>My Ads
            </Text>
        </LinearGradient>
