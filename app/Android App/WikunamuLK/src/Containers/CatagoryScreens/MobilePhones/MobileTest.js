...
export default class MobileTest extends Component {

  constructor(props) {
    super(props);
    this.state = {
      data: [
        {id:1, title: "Galaxy Note 9",  price:"LKR 90 000", image:require('../../../Assets/Test/note9.jpeg')},
        {id:1, title: "iPhone 7 Plus",  price:"LKR 95 000", image:require('../../../Assets/Test/iphone1.jpeg')},
        {id:1, title: "iPhone 8 Plus",  price:"LKR 80 000", image:require('../../../Assets/Test/iphone2.jpeg')},
        {id:1, title: "iPhone XS Max",  price:"LKR 120 000", image:require('../../../Assets/Test/iphonex.jpg')},
                  ...
                  <View style={styles.socialBarContainer}>
                    <View style={styles.socialBarSection}>
                      <TouchableOpacity style={styles.socialBarButton} onPress={() => this.addProductToCart()}>
                        ...
                        <Text style={[styles.socialBarLabel, styles.buyNow]}>View Ad</Text>
                      </TouchableOpacity>
                    </View>
                    <View style={styles.socialBarSection}>
