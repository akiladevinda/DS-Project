...
import HouseRentMore from './HouseRentMore';

const URL_TESTING = 'http://www.powertrend.lk/backend/web/index.php?r=api/paid-books';


export default class HouseRentMain extends Component {
  ...
  addProductToCart(item){
    this.props.navigation.navigate("HouseRentMore",{screen: "HouseRentMore",Item:item,onGoBack: () => this.autoRefresh(),})
  }
    ...
    return (
      ...
      <StatusBar backgroundColor="#3764ad" barStyle="light-content"/>
        ...
        <TouchableOpacity style={styles.drawerIcon} onPress={this.handleBackButtonClick}>
            ...
            <Text style={styles.headerTextMain}>House Rent
            </Text>
        </LinearGradient>
